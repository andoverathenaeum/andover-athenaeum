    ...
    return (
        <div className="pt-10 px-4 sm:px-6 lg:pt-16 lg:px-8">
            <div className="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
                                    ...
                                    <div className="block mt-4">
                                        <div>
                                            ...
                                            {/* <p
                                                ...
                                                dangerouslySetInnerHTML={{__html: previews !== null && previews[i].substring(0, 100) + '...'}}
                                            /> */}
                ...
                <div className="w-full mb-32 p-10 lg:flex lg:m-0 lg:justify-center lg:items-center" style={{ height: 650 }}>
